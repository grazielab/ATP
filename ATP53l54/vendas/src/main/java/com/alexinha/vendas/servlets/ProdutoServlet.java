package com.alexinha.vendas.servlets;
import java.io.IOException;
import java.io.PrintWriter;

import com.alexinha.vendas.models.Produto;
...
public class ProdutoServlet extends HttpServlet{
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(parametroValor != null && parametroIdcategoria != null){
            ...
            out.printf("-- Modulo Produtos -- \nProduto = %s | Valor: R$%.2f | ID = %s", prod1.getNome(), prod1.getValor(), prod1.getIdCategoria());
        }
        else{
            out.printf("-- Modulo Produtos -- \nProduto = %s", prod1.getNome());
        }   
